...
public class FestivalGreetingService {
  ...
  private static final List<FestivalGreetingResponse> BUILT_INS = List.of(
      ...
      builtIn("2026-02-15", "మహా శివరాత్రి", "మహా శివరాత్రి శుభాకాంక్షలు! శివుని అనుగ్రహం మీపై ఉండాలి."),
      builtIn("2026-03-19", "ఉగాది", "ఉగాది శుభాకాంక్షలు! ఈ నూతన సంవత్సరం సంగీతం, సంతోషం నింపాలి."),
      builtIn("2026-03-26", "శ్రీరామ నవమి", "శ్రీరామ నవమి శుభాకాంక్షలు! శ్రీరాముని దీవెనలు మీ కుటుంబంపై ఉండాలి."),
      builtIn("2026-04-02", "హనుమాన్ జయంతి", "హనుమాన్ జయంతి శుభాకాంక్షలు! ధైర్యం, భక్తి మీకు తోడుగా ఉండాలి."),
      builtIn("2026-08-28", "రాఖీ పౌర్ణమి", "రాఖీ పౌర్ణమి శుభాకాంక్షలు! అనుబంధాలు ఎల్లప్పుడూ మధురంగా ఉండాలి."),
      builtIn("2026-09-04", "శ్రీకృష్ణ జన్మాష్టమి", "జన్మాష్టమి శుభాకాంక్షలు! కృష్ణుని వేణుగానం ఆనందం నింపాలి."),
      builtIn("2026-09-14", "వినాయక చవితి", "వినాయక చవితి శుభాకాంక్షలు! విఘ్నేశ్వరుడు మీ విఘ్నాలను తొలగించాలి."),
