...
class _LibraryScreenState extends State<LibraryScreen> {
  ...
  void didChangeDependencies() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      if (!mounted) return;
      try {
        await context.read<MusicController>().refreshPlaylists();
      } catch (_) {
        // Keep the rest of the library usable; the user can retry below.
      }
    });
  }
      ...
      child: CustomScrollView(
        ...
        slivers: [
          ...
          const SliverToBoxAdapter(
              child: SectionTitle(title: 'Your playlists')),
          SliverToBoxAdapter(
            child: SizedBox(
              height: 206,
              child: ListView(
